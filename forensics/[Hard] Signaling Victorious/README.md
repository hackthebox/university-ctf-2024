...
There are 2 ways that I know of that we can approach this. Either by using [MemProcFS](https://github.com/ufrisk/MemProcFS) to create the minidump, but for that we would need to modify the source code and recompile the project [m_proc_minidump.c#L1005](https://github.com/ufrisk/MemProcFS/blob/master/vmm/modules/m_proc_minidump.c#L1005).

Or we could use the [pypykatz](https://github.com/skelsec/pypykatz-volatility3) volatility plugin!
